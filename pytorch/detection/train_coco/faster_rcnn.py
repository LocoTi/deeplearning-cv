...
class FasterRCNN(GeneralizedRCNN):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 min_size=800, max_size=1333,  # 图像预处理时限制的最小尺寸和最大尺寸
                 image_mean=None, image_std=None,
                 # RPN parameters
                 rpn_anchor_generator=None, rpn_head=None,
                 rpn_pre_nms_top_n_train=2000, rpn_pre_nms_top_n_test=1000,  # RPN在nms处理前保留的proposal数量，根据score
                 rpn_post_nms_top_n_train=2000, rpn_post_nms_top_n_test=1000,  # RPN在nms处理后保留的proposal数量
                 rpn_nms_thresh=0.7,
                 rpn_fg_iou_thresh=0.7, rpn_bg_iou_thresh=0.3,  # RPN计算损失时，区分正负样本的阈值
                 rpn_batch_size_per_image=256, rpn_positive_fraction=0.5,  # RPN计算损失时，采样正负样本的比例
